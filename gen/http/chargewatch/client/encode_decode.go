...
// path set to call the "chargewatch" service "healthcheck" endpoint
func (c *Client) BuildHealthcheckRequest(ctx context.Context, v interface{}) (*http.Request, error) {
	u := &url.URL{Scheme: c.scheme, Host: c.host, Path: HealthcheckChargewatchPath()}
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
		return nil, goahttp.ErrInvalidURL("chargewatch", "healthcheck", u.String(), err)
	}
	if ctx != nil {
...
// chargewatch healthcheck endpoint. restoreBody controls whether the response
...
func DecodeHealthcheckResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (interface{}, error) {
	return func(resp *http.Response) (interface{}, error) {
		...
		case http.StatusOK:
			...
			if err != nil {
				return nil, goahttp.ErrDecodingError("chargewatch", "healthcheck", err)
			}
			return body, nil
		default:
			body, _ := ioutil.ReadAll(resp.Body)
			return nil, goahttp.ErrInvalidResponse("chargewatch", "healthcheck", resp.StatusCode, string(body))
		}
	}
}
